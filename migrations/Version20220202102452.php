 ...
 */
final class Version20220202102452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_commande ADD CONSTRAINT FK_98344FA67AB86142 FOREIGN KEY (referrence_id) REFERENCES purchase (id)');
